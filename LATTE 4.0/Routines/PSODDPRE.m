PSODDPRE ;BIR/SAB - Enhanced OP order checks ;2017-09-19  4:32 PM
 ;;7.0;OUTPATIENT PHARMACY;**251,375,387,379,390,372,416,411,LATTE/C0D,LOCAL**;DEC 1997
 ...
 ;
 ; VEN/SMH - *C0D/LATTE - Keep drugs even if no GCN (as variable SEQN) is available.
 ;
 W @IOF
...
FDB ;build drug check input
 ...
 ;K ID,P1,P2 N ODRG,TU S (STA,DNM)="" I '$G(PSOCOPY),'$G(SEQN),'$G(PSODGCK) K SEQN Q ; Changed
 K ID,P1,P2 N ODRG,TU S (STA,DNM)="" ; I '$G(PSOCOPY),'$G(PSODGCK) Q  ; *11310000 VEN/SMH - new: keep going even if no SEQN
