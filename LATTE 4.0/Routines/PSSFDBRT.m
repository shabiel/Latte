PSSFDBRT ;WOIFO/Parviz Ostovari - Sends XML Request to PEPS via HWSC ;2017-09-19  2:34 PM
 ;;1.0;PHARMACY DATA MANAGEMENT;**136,160,C0D/LATTE,LOCAL**;9/30/97
 ;
...
GROUTE(PSSIEN,PSSOUT) ; get the routes for given drug ien in drug file from PESPS via HWSC
 ...
 IF $$GET^XPAR("ALL","C0D LATTE ENABLE?") D  QUIT
