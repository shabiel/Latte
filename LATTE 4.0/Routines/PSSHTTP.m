PSSHTTP ;WOIFO/AV - REENGINERING Sends XML Request to PEPS via HWSC ;2017-09-24  11:50 AM
 ...
 ; @version - 1.0
 ;
 ; Modifications for Mocha bypass by VEN/SMH (*C0D/LATTE)
 ;
 QUIT
 ;;
PEPSPOST(DOCHAND,XML) ;
 ...
 ;
 IF $$GET^XPAR("SYS^PKG","C0D LATTE ENABLE?") Q $$LATTE(.DOCHAND,XML) ; *11310000 - Divergence to Latte...
 ;
 SET PSS("server")="PEPS"
