PSSHRIT ;WOIFO/SG,PO - Transmits a "ping" to determine if FDB server is down and record the down time ;2014-02-03  9:12 AM
 ;;1.0;PHARMACY DATA MANAGEMENT;**136,168,164,11310000,LOCAL**;9/30/97
 ;
